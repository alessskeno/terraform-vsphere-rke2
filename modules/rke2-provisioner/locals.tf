locals {
  ...
  master_endpoints_az3 = try(slice(var.master_ip_range_az3, 0, var.master_node_count), [])
  nfs_ip_az1           = try([var.nfs_ip_az1], [])

  worker_endpoints_az1 = slice(var.worker_ip_range_az1, 0, var.worker_node_count)
  worker_endpoints_az3 = try(slice(var.worker_ip_range_az3, 0, var.worker_node_count), [])
